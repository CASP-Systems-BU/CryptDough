...
// Quasi-Newton optimisation and the secure matrix helpers it needs.
//
// The matrix utilities and the Newton-Schulz inverse come from the
// logistic-regression branch (task 0010); the BFGS driver, its numerical
// gradient and the value-plus-gradient objective interface come from the
// analysis pipeline (task 0009).
