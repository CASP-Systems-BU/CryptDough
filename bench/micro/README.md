The `micro/` directory holds focused micro-benchmarks that measure the performance of individual CryptDough primitives.

Files:

- `micro_aggregation.cpp` – Aggregation operator benchmark.
- `micro_batching.cpp` – Batching benchmark.
...
- `micro_dpf.cpp` – Distributed Point Function (DPF) benchmark.
- `micro_join.cpp` – Join operator micro-benchmark.
- `micro_memory.cpp` – Memory usage benchmark.
- `micro_merge.cpp` – Merge benchmark.
- `micro_ml.cpp` – Machine-learning inference benchmark.
- `micro_ml_local.cpp` – Local (plaintext) machine-learning benchmark.
- `micro_ml_secure.cpp` – Secure machine-learning benchmark.
- `micro_multi_engine.cpp` – Multi-engine benchmark.
...
- `micro_shprg.cpp` – Seed-homomorphic PRG (SHPRG) benchmark.
...
- `micro_sorting_rs.cpp` – Radix-sort sorting benchmark.
