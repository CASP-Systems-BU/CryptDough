...
class SecrecyDatabase : public TPCDatabase<T, Engine> {
   public:
    SecrecyDatabase(double sf, Engine& engine) : TPCDatabase<T, Engine>(sf, engine) {}

    SecrecyDatabase(double sf, sqlite3* sqlite_db, Engine& engine)
        : TPCDatabase<T, Engine>(sf, sqlite_db, engine) {}
    ...
    EncodedTable<T> getSecrecyRTable() {
        ...
        EncodedTable<T> table = this->engine.template secret_share_table<T>({id, ak}, schema);
    ...
    EncodedTable<T> getSecrecySTable() {
        ...
        EncodedTable<T> table = this->engine.template secret_share_table<T>({id}, schema);
    ...
    EncodedTable<T> getDiagnosisTable() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({pid, time, diag}, schema);
    ...
    EncodedTable<T> getMedicationTable() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({pid, time, med}, schema);
    ...
    EncodedTable<T> getPasswordTable() {
        ...
        EncodedTable<T> table = this->engine.template secret_share_table<T>({id, pwd}, schema);
    ...
    EncodedTable<T> getTaxiTable() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({company, fare, type}, schema);
    ...
    EncodedTable<T> getSecrecyT1Table() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({person, coinsurance, state}, schema);
    ...
    EncodedTable<T> getSecrecyT2Table() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({person, disease, cost}, schema);
    ...
    EncodedTable<T> getSecrecyT3Table() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({disease, class_}, schema);
    ...
    EncodedTable<T> getCreditScoreTable() {
        ...
        EncodedTable<T> table =
            this->engine.template secret_share_table<T>({uid, agency, year, cs}, schema);
