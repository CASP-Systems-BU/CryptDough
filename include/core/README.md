The `core/` directory houses the fundamental building blocks of cdough, including container types, communication primitives, MPC protocols, secure operators, and random generators.
...
- `protocols/` – Implementations of the MPC protocols supported by cdough (Beaver 2PC, Replicated 3PC, and Fantastic 4PC).
