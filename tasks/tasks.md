...
- 0007 — Secure matrix inversion via Newton–Schulz iterations — Status: Done — [tasks/0007_secure-matrix-inversion-newton-schulz.md](0007_secure-matrix-inversion-newton-schulz.md)
