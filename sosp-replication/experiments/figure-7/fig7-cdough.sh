...
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 4 -s lan -t 4 -b -12 energy >> "$log_dir/lan-3pc-energy.log"
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 4 -s lan -t 4 -b -12 medical >> "$log_dir/lan-3pc-medical.log"
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 4 -s lan -t 4 -b -12 cloud >> "$log_dir/lan-3pc-cloud.log"
...
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 16 -s wan -t 4 -b -1 energy >> "$log_dir/wan-3pc-energy.log"
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 16 -s wan -t 4 -b -1 medical >> "$log_dir/wan-3pc-medical.log"
$run_script -p 3 --sort bitonicsort -r 4194304 -c nocopy -n 16 -s wan -t 4 -b -1 cloud >> "$log_dir/wan-3pc-cloud.log"
