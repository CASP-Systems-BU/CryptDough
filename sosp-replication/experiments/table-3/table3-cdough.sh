...
$run_script -p 2 --no-division-correction -r 192 -c nocopy -n 1 -s lan -t 0 -b -1 alexnet >> "$log_dir/lan-2pc-alexnet.log"
$run_script -p 2 --no-division-correction -r 192 -c nocopy -n 1 -s lan -t 0 -b -1 vgg16 >> "$log_dir/lan-2pc-vgg16.log"
$run_script -p 2 --no-division-correction -r 8 -c nocopy -n 1 -s lan -t 0 -b -1 vgg16-imagenet >> "$log_dir/lan-2pc-vgg16-imagenet.log"
